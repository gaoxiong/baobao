...
public class ActionBarView extends AbsActionBarView {
  ...
  public ActionBarView(Context context, AttributeSet attrs) {
    ...
    mProgressBarPadding =
        a.getDimensionPixelOffset(R.styleable.SherlockActionBar_progressBarPadding, 0);
    ...
    final int customNavId =
        a.getResourceId(R.styleable.SherlockActionBar_customNavigationLayout, 0);
    if (customNavId != 0) {
  ...
  /**
   * Added by yangkai@wandoujia.com
   * 
   * @return menu
   */
