...
/**
 * Created by gaoxiong on 15-1-22.
 */
public class BaoHorizontalScrollView extends HorizontalScrollView {

  public BaoHorizontalScrollView(Context context, AttributeSet attrs,
                                 int defStyle) {
  ...
  public BaoHorizontalScrollView(Context context) {
    super(context);
    init(context);
  }
  ...
  public void initViews(View[] children, int scrollToViewIdx,
    ...
    ViewTreeObserver.OnGlobalLayoutListener listener = new MyOnGlobalLayoutListener(parent,
  ...
  class MyOnGlobalLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void onGlobalLayout() {
      ...
      final HorizontalScrollView me = BaoHorizontalScrollView.this;
